...
COMMENT ON TABLE "answs" IS 'Table contain the answers for the questions, the field arigth says if the answer is correct';
...
COMMENT ON TABLE "words" IS 'Table contain all the words that will be show in the application.';
